    ...
    <div className="w-full max-w-4xl mx-auto p-4">
      <div className="text-center mb-8">
        <h1 className={`
          ...
          bg-gradient-to-r from-${cards[0]?.colorTheme.primary}-600 
          to-${cards[0]?.colorTheme.secondary}-600 
          mb-4 flex items-center justify-center
        `}>
          {showAnimalIcons && <Dog className={`w-8 h-8 mr-2 text-${cards[0]?.colorTheme.accent}-600`} />}
          Match Bengali Numbers
          {showAnimalIcons && <Cat className={`w-8 h-8 ml-2 text-${cards[0]?.colorTheme.accent}-600`} />}
        </h1>
        <div className="mb-4">
